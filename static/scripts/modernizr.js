...
!(function (n, e, s, o) {
  ...
  const l = [];
  const f = s.documentElement;
  const r = f.nodeName.toLowerCase() === "svg";
  !(function () {
    let n, e, s, o, t, f, r;
    for (const c in i)
    ...
    (function (n) {
      let e = f.className;
      const s = Modernizr._config.classPrefix || "";
...
window.Modernizr = (function (window, document, undefined) {
  ...
  const testMediaQuery = function (mq) {
    ...
    injectElementWithStyles(
      ...
      function (node) {
        bool =
          (window.getComputedStyle ? getComputedStyle(node, null) : node.currentStyle).position ==
          "absolute";
      }
    );
    ...
    Function.prototype.bind = function bind(that) {
      ...
      var bound = function () {
        if (this instanceof bound) {
          ...
          const result = target.apply(self, args.concat(slice.call(arguments)));
  ...
  tests.audio = function () {
    ...
    try {
      if ((bool = !!elem.canPlayType)) {
        ...
        bool.m4a = (elem.canPlayType("audio/x-m4a;") || elem.canPlayType("audio/aac;")).replace(
          /^no$/,
          ""
        );
      }
