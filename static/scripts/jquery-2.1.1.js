...
(function (global, factory) {
  ...
  const // Use the correct document accordingly with window argument (sandbox)
	...
	---------------------------------------------------------------------- */
        ...
        if (support.getById) {
          ...
          Expr.filter.ID = function (id) {
            ...
            return function (elem) {
              const node =
                typeof elem.getAttributeNode !== strundefined && elem.getAttributeNode("id");
...
*/
    ...
    jQuery.each({ focus: "focusin", blur: "focusout" }, function (orig, fix) {
      ...
      jQuery.event.special[fix] = {
        setup: function () {
          ...
          const attaches = data_priv.access(doc, fix);
        ...
        teardown: function () {
          const doc = this.ownerDocument || this;
          const attaches = data_priv.access(doc, fix) - 1;
  ...
  function getAll(context, tag) {
    const ret = context.getElementsByTagName
    ...
    if (window.getComputedStyle) {
      jQuery.extend(support, {
        ...
        reliableMarginRight: function () {
          ...
          let ret;
          const marginDiv = div.appendChild(document.createElement("div"));
  ...
  const // swappable if display is none or starts with table except "table", "table-cell", or "table-caption"
  ...
  function defaultPrefilter(elem, props, opts) {
    ...
    let dataShow = data_priv.get(elem, "fxshow");
  ...
  function Animation(elem, properties, options) {
    ...
    let stopped;
    let index = 0;
    const length = animationPrefilters.length;
    ...
    toggleClass: function (value, stateVal) {
      ...
      return this.each(function () {
        if (type === "string") {
          ...
          this.className =
            this.className || value === false ? "" : data_priv.get(this, "__className__") || "";
        }
      });
    },
