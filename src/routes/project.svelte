...
<body>
    ...
    <div class="top-bar">
        ...
        <p><a href="../index.html">Home</a> / <a href="../portfolio.html">Portfolio</a> / Mackee Trading App Design</p>
    </div>
    <div class="container main-container">
        <div class="col-md-12">
            <img src="../img/mackee/mockup-global.jpg" alt="" class="img-responsive" />
            <div class="h-30"></div>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-9">
            <p>Mackee was co-founded by a group of 5 students of which I was part as Lead Designer.<br>
                It is a mobile application to learn trading and all its subtleties in a fun way.</p>
            <p>Mackee isn't available on app stores and some of the mockups are only on my portfolio.</p>
        </div>
        <div class="col-md-3">
            <ul class="cat-ul">
                <li><i class="ion-ios-circle-filled"></i>Design</li>
                <li><i class="ion-ios-circle-filled"></i>Mobile App</li>
                <li><i class="ion-ios-circle-filled"></i>Mockups</li>
            </ul>
            <div class="h-10"></div>
            <h4>Share</h4>
            <ul class="social-ul">
