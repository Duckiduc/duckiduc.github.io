<div>
  <div class="top-bar">
    <h1>Gear & Softwares I use</h1>
    <p><a href="index.html">Home</a> / Gear & Softwares I use</p>
  </div>
  <div class="container main-container clearfix">
    <div class="col-md-4">
      <img src="img/macos.jpg" class="img-responsive" alt="" />
    </div>
    <div class="col-md-8">
  ...
  <h2>Softwares</h2>
  <h3 style="text-align: center;">All download links provided</h3>
  <p style="text-align: center;">
    Icons from the project <a href="https://macosicons.com">MacOSicons</a> from
    <a href="https://github.com/sponsors/elrumo?o=esc">Elias</a>. The icons used are the property of
    their respective owners.
  </p>
  <div class="container main-container clearfix">
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/iterm2.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
        ...
        <p>
          <a
            ...
            target="_blank"
            rel="noreferrer noopener">PowerLevel10k</a
          >
          combined with
          <a
            href="https://github.com/rainglow/iterm/blob/master/themes/Overflow%20(rainglow).itermcolors"
            target="_blank"
            rel="noreferrer noopener">Overflow</a
          >
          by <a href="https://rainglow.io" target="_blank" rel="noreferrer noopener">Rainglow</a>.
        </p>
      </div>
    </div>
    <hr />
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/vscode.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
        ...
        <p>
          <a
            ...
            target="_blank"
            rel="noreferrer noopener">Auto Close Tag</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-rename-tag"
            target="_blank"
            rel="noreferrer noopener">Auto Rename Tag</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=HookyQR.beautify"
            target="_blank"
            rel="noreferrer noopener">Beautify</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=karunamurti.haml"
            target="_blank"
            rel="noreferrer noopener">Better HAML</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=alexdima.copy-relative-path"
            target="_blank"
            rel="noreferrer noopener">Copy Relative Path</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint"
            target="_blank"
            rel="noreferrer noopener">ESLint</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=ecmel.vscode-html-css"
            target="_blank"
            rel="noreferrer noopener">HTML CSS Support</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=yzhang.markdown-all-in-one"
            target="_blank"
            rel="noreferrer noopener">Markdown All in One</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced"
            target="_blank"
            rel="noreferrer noopener">Markdown Preview Enhanced</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=mechatroner.rainbow-csv"
            target="_blank"
            rel="noreferrer noopener">Rainbow CSV</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=rebornix.Ruby"
            target="_blank"
            rel="noreferrer noopener">Ruby</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=octref.vetur"
            target="_blank"
            rel="noreferrer noopener">Vetur</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=vscode-icons-team.vscode-icons"
            target="_blank"
            rel="noreferrer noopener">vscode-icons</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=jcbuisson.vue"
            target="_blank"
            rel="noreferrer noopener">Vue</a
          >
          |
          <a
            href="https://marketplace.visualstudio.com/items?itemName=hollowtree.vue-snippets"
            target="_blank"
        ...
        <p>
          ...
          by
          <a
            href="https://marketplace.visualstudio.com/items?itemName=daylerees.rainglow"
            target="_blank"
            rel="noreferrer noopener">Rainglow</a
          >.
        </p>
      </div>
    </div>
    ...
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/alfred4.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
          <a href="https://www.alfredapp.com" target="_blank" rel="noreferrer noopener">Alfred 4</a>
    ...
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/lepton.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
          <a
            href="https://github.com/hackjutsu/Lepton/releases/tag/v1.9.1"
            target="_blank"
            rel="noreferrer noopener">Lepton</a
          > (Gist Manager)
        </h3>
    ...
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/macdown.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
          <a href="https://macdown.uranusjr.com" target="_blank" rel="noreferrer noopener"
            >MacDown</a
          > (MarkDown editor)
        </h3>
    ...
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/notion.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
    ...
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/sourcetree.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
    ...
    <div class="container secondary-container clearfix">
      <div class="col-md-2">
        <img src="icons/spark.png" class="img-responsive" alt="" />
      </div>
      <div class="col-md-10">
        <h3 class="uppercase">
          <a href="https://sparkmailapp.com" target="_blank" rel="noreferrer noopener">Spark</a> (Email
          Client)
        </h3>
        <h5>Mac OS as primary</h5>
        <div class="h-10" />
